...
(function (global) {
    ...
    //heroCanvas.onclick = function(event) {
    //    //标准的获取鼠标点击相对于canvas画布的坐标公式
    //    var y = event.pageY - heroCanvas.getBoundingClientRect().top;
    //    var pointY = y / 83;
    //    if (pointY == 0) {
    //        hero1.heroId = 'images/char-boy.png';
    //    } else if (pointY == 1) {
    //        hero1.heroId = 'images/char-cat-girl.png';
    //    } else if (pointY == 2) {
    //        hero1.heroId = 'images/char-horn-girl.png';
    //    } else if (pointY == 3) {
    //        hero1.heroId = 'images/char-pink-girl.png';
    //    } else {
    //        hero1.heroId = 'images/char-princess-girl.png';
    //    }
    ...
    function checkCollisions() {
        allEnemies.forEach(function (enemy) {
            if ((player.x > enemy.x - 80 && player.x < enemy.x + 80) && (Math.abs(player.y - enemy.y) <= 20)) {
                player.isLive = false;
            }
        });
    }
